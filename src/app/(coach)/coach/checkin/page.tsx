...
import { markAttendance, markSessionMark } from "../attendance/actions";
...
export default async function CheckinPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Check-in"
        description="Tap NFC cards to record attendance, or mark students by hand below (incl. excused). You can mark any time today."
      />
